...
const TIER_HEADER_COLORS: Record<string, { bg: string; border: string; text: string }> = {
  HT1: { bg: 'rgba(180,130,0,0.15)', border: '#b8860b', text: '#f0c040' },
  HT2: { bg: 'rgba(100,100,100,0.15)', border: '#6e6e6e', text: '#c0c0c0' },
  HT3: { bg: 'rgba(120,60,20,0.15)', border: '#7c4a2a', text: '#cd7f32' },
  LT1: { bg: 'rgba(50,50,50,0.15)', border: '#444', text: '#aaa' },
  LT2: { bg: 'rgba(50,50,50,0.10)', border: '#383838', text: '#999' },
  LT3: { bg: 'rgba(50,50,50,0.08)', border: '#303030', text: '#888' },
  LT4: { bg: 'rgba(50,50,50,0.06)', border: '#282828', text: '#777' },
  LT5: { bg: 'rgba(50,50,50,0.04)', border: '#222', text: '#666' },
};
    ...
    <div className="rankings-page">
      <div className="rankings-container">
        ...
        <div className="rankings-info-bar">
          ...
          <div className="server-ip-badge">
            <img src="/icons/pvpclub.webp" alt="PvP Club" height={20} style={{ borderRadius: 3 }} />
            <div className="server-ip-text">
              <span className="server-ip-label">SERVER IP</span>
              <span className="server-ip-value">outertiers.net</span>
            </div>
          </div>
        </div>
