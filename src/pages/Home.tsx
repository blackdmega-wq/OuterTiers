    ...
    <div className="home-page">
      ...
      <div className="features-section">
        ...
        <div className="features-grid">
          ...
          <FeatureCard delay="0.07s" icon={<img src="/feature-icons/feature-2.png" alt="" style={{width:48,height:48,objectFit:'contain'}} />} title="Zero Corruption Tolerated" desc="We won't allow corrupted staff or testers on OuterTiers. If anyone isn't neutral and fair, they will be immediately demoted. Boosting players is strictly forbidden." />
          <FeatureCard delay="0.14s" icon={<img src="/feature-icons/feature-3.png" alt="" style={{width:48,height:48,objectFit:'contain'}} />} title="Accurate Rankings" desc="We are tired of testers ranking players unfairly and getting away with it. OuterTiers puts a lot of value into professionalism — every tier test is strictly overseen to guarantee accurate and fair placements." />
